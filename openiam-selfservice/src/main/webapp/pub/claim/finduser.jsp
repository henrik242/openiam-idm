...
<table border="0" width="500" align="center">
  ...
  <tr>
    <td class="title" colspan="2">
        Account Claim Wizard - Find User
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="tdlight" ><form:input path="redid" size="40" maxlength="40" />
    </td>
  </tr>
   ...
   <tr>
    ...
    <td class="tdlight" ><form:input path="dob" size="40" maxlength="40" />
     </td>
  </tr>
  ...
  <tr>
    ...
    <td class="tdlight" ><form:input path="regid" size="40" maxlength="40" />
     </td>
  </tr>
