...
%>
   <tr>
   	<td colspan="5" class="tddark" align="center">User Attributes</td>
   </tr>
<%
...
%>
 	<tr>
       ...
       <% 
       	...
       	if (comp == null) { %>
       		<input type="text" name="*<%=val.getAttributeName()%>-<%=val.getMetadataId()%>" size="30"> 
      <% }else { 
      %>
      		<input type="text" name="*<%=val.getAttributeName()%>-<%=val.getMetadataId()%>"  value="<%=comp.getValue() %>" size="30"> 
      <% } %>
      </td>
...
%>
       <td class="tddark" align="right"><%= val.getAttributeName() %></td>
        	 ...
        	 <input type="text" name="*<%=val.getAttributeName()%>-<%= val.getMetadataId() %>" size="30"> </td>
