...
<table width="600pt" border="0" cellspacing="2" cellpadding="1" align="center">
	...
	<tr>
		<td colspan="4"><font color="red">Profile information has been successfully saved.</font>
   ...
   <tr>
    ...
    <tr>
         ...
         <td class="tddarknormal" align="right">Dept</td>
         <td class="tdlight">
    ...
    <tr >
         <td class="tddarknormal"  align="right">Title</td>
         <td class="tdlight">
...
<html:hidden property="faxPhoneId" />
       ...
       <td class="tddarknormal" align="right">Work Phone</td>
 ...
 <tr>
  ...
  <tr>
       ...
       <td class="tddarknormal" align="right">E-mail</td>
