...
<table width="600pt" border="0" cellspacing="2" cellpadding="1" align="center">
   ...
   <tr>
    ...
    <tr>
         ...
         <td class="tdlightnormal" colspan="3"><%= JSPUtil.display( userForm.get("title") ) %>
         </td>
    ...
    <tr>
         <td class="tddark"  align="right" width="25%">Business Unit</td>
         <td class="tdlightnormal" width="25%"> </td>
		 <td class="tddark"  align="right" width="25%">Manager</td>
		 <td class="tdlight" width="25%">
		 <% if (superVis != null) {%>
         <a href="priv/profile.do?method=directory&personId=<%=superVis.getSupervisor().getUserId() %>"%>
...
<html:hidden property="faxPhoneId" />
 ...
 <tr>
  ...
  <tr>
       <td class="tddark" align="right">HR Code</td>
       <td class="tdlightnormal"></td>
       <td class="tddark" align="right"></td>
       <td class="tdlightnormal"> </td>
   </tr>
  <tr>
       <td class="tddark" align="right">Last Modified</td>
       <td class="tdlightnormal"></td>
       <td class="tddark" align="right"></td>
       <td class="tdlightnormal"> </td>
   </tr>
