...
<table width="620" border="0" cellspacing="2" cellpadding="1" align="center"> 
   ...
   <tr>
	  <td class="tddarknormal" align="right">A.K.A(Nickname)</td>
	  <td>
    ...
    <tr >
         ...
         <td class="tdlightnormal">
	            <form:select path="managedBy">
          		...
          		<br><form:errors path="managedBy" cssClass="error" />  
		</td>
		<td class="tddarknormal"  align="right">User Principal Name<font color="red">*</font></td>
         <td class="tdlight" colspan="3" ><form:input path="userPrincipalName" size="50" maxlength="50"  readonly="false" /></td>
    ...
    <tr >
     ...
     <tr >
		...
		<td class="tddarknormal"  align="right" colspan="3">Last Date</td>
		<td class="tdlight"><form:input path="user.lastDate" size="20" /><br>
