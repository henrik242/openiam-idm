...
public class SessionFilter implements javax.servlet.Filter {
	...
	public void doFilter(
		...
		if ( url == null || url.equals("/") || url.endsWith("index.do") || url.endsWith("login.cnt")   ) {
	...
	private void loadStaticData(HttpSession session, ServletContext servletContext)  {
		...
		// load public menus
			navigationDataService = (org.openiam.idm.srvc.menu.service.NavigatorDataService)webContext.getBean("navigatorDataService");
