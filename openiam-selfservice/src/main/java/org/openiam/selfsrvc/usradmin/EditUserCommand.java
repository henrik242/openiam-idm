...
public class EditUserCommand implements Serializable {
	...
	String policyName;
	Set<PolicyAttribute> passwordPolicyAttr;
	...
	public Set<PolicyAttribute> getPasswordPolicyAttr() {
		return passwordPolicyAttr;
	}

	public void setPasswordPolicyAttr(Set<PolicyAttribute> passwordPolicyAttr) {
		this.passwordPolicyAttr = passwordPolicyAttr;
	}
