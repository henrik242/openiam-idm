...
//	void setResourceRoleDao(ResourceRoleDAO resourceRoleDao);
	 ...
	 * @return the attribute map
	 */
	AttributeMap addAttributeMap(AttributeMap attributeMap) ;
	 ...
	 * @return the attribute map
	 */
	AttributeMap updateAttributeMap(AttributeMap attributeMap) ;
	 ...
	 */
	List<AttributeMap> getResourceAttributeMaps(String resourceId);
