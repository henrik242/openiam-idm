...
public class ManagedSys implements java.io.Serializable {
	...
	private Set<ResourceApprover> resourceApprovers = new HashSet<ResourceApprover>(0);
	/*
	...
	*/
	...
	public Set<ResourceApprover> getResourceApprovers() {
		return resourceApprovers;
	}

	public void setResourceApprovers(Set<ResourceApprover> resourceApprovers) {
