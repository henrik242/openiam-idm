...
public class Role implements java.io.Serializable {
  ...
  /**
	...
	public boolean equals(Object obj) {
		...
		return this.description.equals(compareRole.description) && 
		 	this.id.equals(compareRole.id) && 
		 	this.inheritFromParent.equals(compareRole.inheritFromParent) && 
		 	this.internalRoleId.equals(compareRole.internalRoleId) && 
		 	this.metadataTypeId.equals(compareRole.metadataTypeId) && 
		 	this.ownerId.equals(compareRole.ownerId);
	}
