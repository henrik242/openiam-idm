...
public class IdmAuditLog  implements java.io.Serializable {
    ...
    public IdmAuditLog(String objectTypeId, String actionId, String actionStatus, String reason, 
	 ...
	 */
	public void setSynchAttributes(String objectTypeId,
			String objectId,
			String actionId,
			String userId,
			String sessionId) {
	...
	public void setSynchUserAttributes(
			String objectTypeId,
			String objectId,
			String actionId,
			String actionStatus,
		...
		this.reason = reason;
		this.customAttrname1 = attrName;
		this.customAttrvalue1 = attrValue;
	}

    public void updateSynchAttributes(String actionStatus, String reason, String reasonDetail) {
        this.actionStatus = actionStatus;
        this.reason = reason;
        this.reasonDetail = reasonDetail;
