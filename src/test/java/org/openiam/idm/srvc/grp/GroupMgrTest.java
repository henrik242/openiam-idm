...
/*	public void testAddGroupToRole() {
		...
		grpMgr.addGroupToRole(grp2.getGrpId(), role.getServiceId(), role.getRoleId());
		
	}
	public void testAdd2ndGroupToRole() {
		
		grpMgr.addGroupToRole(grp3.getGrpId(), role.getServiceId(), role.getRoleId());
		
	}

	public void testGetGroupsInRole() {
		
		List<Group> grpList = grpMgr.getGroupsInRole(role.getServiceId(), role.getRoleId());
		assertNotNull(grpList);
		assertEquals(2, grpList.size());
	}
	
	
	public void testRemoveGroupFromRole() {
		grpMgr.removeGroupFromRole(grp2.getGrpId(), role.getServiceId(), role.getRoleId());
	}


	public void testRemoveAllGroupsFromRole() {
		this.grpMgr.removeAllGroupsFromRole( role.getServiceId(), role.getRoleId());
	}

	public void testRemoveRole() {
		
	
		roleMgr.removeRole(role.getServiceId(), role.getRoleId());

		assertNull( roleMgr.getRole(role.getServiceId(), role.getRoleId()));
	}
*/	
