...
public interface RoleDataService {
	...
	/**
	 * Retrieves a role object and its dependent objects based on the roleId and the serviceId. 
	 ...
	 * @return
	 */
	org.openiam.idm.srvc.role.dto.Role getRoleWithDependants(String serviceId, String roleId);
