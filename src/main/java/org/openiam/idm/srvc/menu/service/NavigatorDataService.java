...
public interface NavigatorDataService {
	 ...
	 */
	List<Menu> getMenuGroup(String menuGroupId);

	/**
	  * Returns a list of valid menu options for the requested menu group without taking from that region.
	  * This mode is typically used in public or guest setting where the user id is not known.
	  * @return List<Menu>
	 * @param menuGroupId -The menu group for which you are trying to locate the options
	 * @param languageCd -The language in which the menu information is to be retrieved.
	 */
	List<Menu> getMenuGroup(String menuGroup, String languageCd);



	/**
	  * Returns a list of valid menu options for the requested menu group for the user.
	  * @param  menuGroupId The menu group for which you are trying to locate the options
	  * @param  userId    The user cd for which you are trying to find valid menu options
	  * @returns  ArrayList A list containing valid menu options.
	  * @throws   RemoteException
	  */
	List<Menu> getMenuGroupByUser(String menuGroupId, java.lang.String userId) ;
	/**
	  * Returns a list of valid menu options for the requested menu group for the user.
	  * @param  menuGroupId - The menu group for which you are trying to locate the options
	  * @param  userId      - The user cd for which you are trying to find valid menu options
	  * @param languageCd   - The language for which the menus are to be selected.
	  * @returns  ArrayList A list containing valid menu options.
	  */
	List<Menu> getMenuGroupByUser(String menuGroupId, java.lang.String userId, String languageCd);
	...
	/**
	 * Returns a <code>String</code> of MenuIds for all the menus in the
	 * parentMenuGroupId hierachy. This includes menu options found several level deep in the
	 * hiearchy. The String of Ids is comma separated.
	 * @param parentMenuGroupId
	 * @param languageCd
	 * @return String
	 */
