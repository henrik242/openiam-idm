...
CREATE TABLE SYNCH_CONFIG (
	   ...
	   SYNCH_FREQUENCY		VARCHAR(20),
	   DELETE_RULE			VARCHAR(80),
	   PROCESS_RULE			VARCHAR(80),
	   REJECT_RULE			VARCHAR(80),
	   TRANSFORMATION_RULE	VARCHAR(80),
	   MATCH_FIELD_NAME		VARCHAR(40),
	   MATCH_MANAGED_SYS_ID VARCHAR(32),
	   MATCH_SRC_FIELD_NAME VARCHAR(40),
