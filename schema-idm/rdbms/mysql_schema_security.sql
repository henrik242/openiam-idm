...
CREATE TABLE RECONILIATION_RESULT (
  RECON_RESULT_ID	 varchar(32) NOT NULL,
  RECON_CONFIG_ID 	 VARCHAR(32) NULL,
...
CREATE TABLE RECON_RESULT_DETAIL (
  RECON_RESULT_DETAIL_ID	 varchar(32) NOT NULL,
  RECON_RESULT_ID 			 VARCHAR(32) NULL,
  OBJECT_KEY				 VARCHAR(320) NULL,
  SITUATION     			 DATE NULL,
  RESULT	  			 	 VARCHAR(20) NULL,
  PRIMARY KEY  (RECON_RESULT_DETAIL_ID),
CONSTRAINT RECON_RESULT FOREIGN KEY (RECON_RESULT_ID)
    REFERENCES RECONILIATION_RESULT(RECON_RESULT_ID)
) ENGINE=InnoDB;
...
CREATE TABLE SYNCH_ACTIVITY_LOG(
    ACTIVITY_LOG_ID    		VARCHAR(32)    NOT NULL,
    LOG_TYPE				VARCHAR(20)	   NOT NULL, /* SYNCH, RECONCIL */
    OBJECT_ID     			VARCHAR(32)    NOT NULL, /* ID FOR SYNCH OR RECONCIL */
    LOG_START_TIME      	DATE		   NULL,
	STATUS					VARCHAR(20)    NULL,     /* */
    PRIMARY KEY (ACTIVITY_LOG_ID)
) ENGINE=InnoDB;

CREATE TABLE ACTIVITY_LOG_DETAIL(
	ACTIVITY_LOG_DETAIL_ID	VARCHAR(32)	   NOT NULL,
    ACTIVITY_LOG_ID    		VARCHAR(32)    NOT NULL,
    MSG						VARCHAR(100)   NULL,
    STATUS					VARCHAR(20)	   NULL,
    DATA_ROW				TEXT		   NULL,
    PRIMARY KEY (ACTIVITY_LOG_DETAIL_ID), 
    CONSTRAINT ACTIVITY_LOG FOREIGN KEY (ACTIVITY_LOG_ID)
    REFERENCES SYNCH_ACTIVITY_LOG(ACTIVITY_LOG_ID)
) ENGINE=InnoDB;
