...
insert into COMPANY(company_id, company_name, status, type_ID, DOMAIN_NAME) values('100','OpenIAM', 'ACTIVE', 'OrgOpenIAM','openiam.com');
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID,SERVICE_ID) VALUES('SECURITY_MENU','SUPER_SEC_ADMIN','IDM');
...
INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID) VALUES('103','Script Connector', 'Groovy Script Connector', 'ACTIVE', '53', 'USR_SEC_DOMAIN', '', null,'CLEAR', '103'   );
...
insert into RES (RESOURCE_ID, RESOURCE_TYPE_ID,NAME, DISPLAY_ORDER, MANAGED_SYS_ID ) VALUES ('103', 'MANAGED_SYS', 'Script Con', 3, '103');
...
/* Indicates if a resource should be included in a sync process when the identity changes */
/* insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('201', '100','INCLUDE_PSWD_SYNC', 'N'); */
/* Insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('201', '1','INCLUDE_ID_CHNG_SYNC', 'N'); */
...
insert into MNG_SYS_OBJECT_MATCH(OBJECT_SEARCH_ID, MANAGED_SYS_ID, OBJECT_TYPE, MATCH_METHOD, SEARCH_FILTER, BASE_DN, SEARCH_BASE_DN ,KEY_FIELD) VALUES('101', '100', 'USER', 'BASE_DN', '(&(objectClass=user)(sAMAccountName=?))','CN=Users,DC=build,DC=openiam,DC=local', 'DC=openiam,DC=local','cn');
