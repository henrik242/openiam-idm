...
CREATE TABLE IAM_SYS_MESSAGES (
   MSG_DELIVERY_ID 			VARCHAR(32) NOT NULL,
   NAME						VARCHAR(40) NULL,
   TARGET_AUDIENCE_TYPE 	VARCHAR(20) NULL,
   TARGET_AUDIENCE 			VARCHAR(255) NULL,
   START_DATE 				DATE NULL,
   ...
   MSG 						TEXT NULL,
   SHOW_ON_RESOURCE			VARCHAR(40) NULL,
   DELIVER_BY				VARCHAR(20) NULL,  /* EMAIL, ONLINE */
   MSG_FROM					VARCHAR(80) NULL,  /* IF ITS AN EMAIL */
