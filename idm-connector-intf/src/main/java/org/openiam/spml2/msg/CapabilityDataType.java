...
public class CapabilityDataType  extends ExtensibleType
{
    ...
    public CapabilityDataType() {}

    public CapabilityDataType(Boolean mustUnderstand,
    ...
    public CapabilityDataType(String capabilityURI) {
