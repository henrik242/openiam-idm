 ...
 * generated in the oasis.names.tc.spml._2._0 package. 
...
// spec based namespace = urn:oasis:names:tc:SPML:2:0
		
    private final static QName _Select_QNAME = new QName("http://www.openiam.org/service/connector", "select");
    private final static QName _AddResponse_QNAME = new QName("http://www.openiam.org/service/connector", "addResponse");
    private final static QName _ListTargetsRequest_QNAME = new QName("http://www.openiam.org/service/connector", "listTargetsRequest");
    private final static QName _LookupRequest_QNAME = new QName("http://www.openiam.org/service/connector", "lookupRequest");
    private final static QName _LookupResponse_QNAME = new QName("http://www.openiam.org/service/connector", "lookupResponse");
    private final static QName _ModifyResponse_QNAME = new QName("http://www.openiam.org/service/connector", "modifyResponse");
    private final static QName _AddRequest_QNAME = new QName("http://www.openiam.org/service/connector", "addRequest");
    private final static QName _DeleteResponse_QNAME = new QName("http://www.openiam.org/service/connector", "deleteResponse");
    private final static QName _ModifyRequest_QNAME = new QName("http://www.openiam.org/service/connector", "modifyRequest");
    private final static QName _DeleteRequest_QNAME = new QName("http://www.openiam.org/service/connector", "deleteRequest");
    private final static QName _ListTargetsResponse_QNAME = new QName("http://www.openiam.org/service/connector", "listTargetsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: oasis.names.tc.spml._2._0
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "select")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "listTargetsRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "lookupRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "lookupResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "modifyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "addRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "deleteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "modifyRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "deleteRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.openiam.org/service/connector", name = "listTargetsResponse")
