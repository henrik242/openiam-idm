...
@XmlType(name = "ProvisionReqResponse", propOrder = {
    "request"
})
public class ProvisionReqResponse extends Response{

	ProvisionRequest request;

	public ProvisionReqResponse() {
		super();
	}

	public ProvisionReqResponse(ResponseStatus s) {
		super(s);
	}
