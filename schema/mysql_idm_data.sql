...
insert into METADATA_TYPE(TYPE_ID, DESCRIPTION, SYNC_MANAGED_SYS) values('MANAGED_SYSTEM','Managed System', 0);
...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('USERIDENTITY','QUERYUSER','Identities','User Identities','userIdentity.cnt', 'en',2);
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('USERGROUP','QUERYUSER','Group','User Groups','userGroup.cnt', 'en',3);
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('USERROLE','QUERYUSER','Role','User Role','userRole.cnt', 'en',4);
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('USERHISTORY','QUERYUSER','History','User History','userHistory.cnt', 'en',5);
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('USERPSWDRESET','QUERYUSER','Password Reset','Password Reset','resetPassword.cnt', 'en',6);
...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('MNGSYS','PROVISIONING','Managed Resource','Managed Resource','managedSysList.cnt', 'en',4);
...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('PSWDCHANGE_RPT','PASSWORDREPORT','Password Change','Password Change Report','home.jsp?bodyjsp=ui/report/passwordRpt.html', 'en',1);
...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('ALLROLERPT','ACCESSREPORT','All Roles','All Roles Report','allRolesReport.report?method=allRole', 'en',1);
...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('ORGPOLICY','ADMIN','Org Policy','Org Policy','orgPolicyList.cnt', 'en',4);
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('SYSNOTIFICATION','ADMIN','Sys Notification','Sys Notification','sysMessageList.cnt', 'en',5);
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERSUMMARY','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERIDENTITY','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERGROUP','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERROLE','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERHISTORY','SUPER_SEC_ADMIN');
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID) VALUES('USERPSWDRESET','SUPER_SEC_ADMIN');
...
insert into STATUS ( CODE_GROUP, status_cd, LANGUAGE_CD, status_type, description, COMPANY_OWNER_ID, SERVICE_ID) values( 'USER', 'DISABLED','en','String','DISABLED','100', 'IDM');
...
INSERT INTO PRIVILEGE(PRIVILEGE_ID, DESCRIPTION) VALUES('NA','NOT APPLICABLE');
...
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION, OPERATION, POLICY_PARAM_HANDLER,PARAM_GROUP) VALUES('119','100','CONSECUTIVE_CHARS','Number of consecutive characters allowed', null,'diamelle.security.pwd.policy.ConsectutiveCharRule', 'PSWD_COMPOSITION');
...
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION, OPERATION, POLICY_PARAM_HANDLER,PARAM_GROUP) VALUES('123','100','VOWELS_IN_PWD','Reject Password containing vowels ','boolean','diamelle.security.pwd.policy.PasswordVowelRule', 'PSWD_COMPOSITION');
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION, OPERATION, POLICY_PARAM_HANDLER,PARAM_GROUP) VALUES('124','100','REJECT_NUM_START','Reject passwords that begin or end with a numeric character','boolean', 'diamelle.security.pwd.policy.NumericStartRule', 'PSWD_COMPOSITION');
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION, OPERATION, POLICY_PARAM_HANDLER,PARAM_GROUP) VALUES('125','100','HAS_NUMERIC_AT','Password to contain numeric chars at following positions', null,'diamelle.security.pwd.policy.NumericPositionRule', 'PSWD_COMPOSITION');
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION, OPERATION, POLICY_PARAM_HANDLER,PARAM_GROUP) VALUES('126','100','HAS_ALPHA_NUM_AT','Password to contain alpha numeric chars at following positions', null,'diamelle.security.pwd.policy.AlphaPositionRule', 'PSWD_COMPOSITION');
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION, OPERATION, POLICY_PARAM_HANDLER,PARAM_GROUP) VALUES('128','100','FORCE_NON_ALPHA_NUM_AT','Force password to contain non-alpha numeric chars at following positions', null,'diamelle.security.pwd.policy.NonAlphaNumPositionRule', 'PSWD_COMPOSITION');
...
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION) VALUES('150','103','DOMAIN_ID','Security domain associated with the policy');
...
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION) VALUES('156','103','ACCESS_POLICY','Policy to access the system');
...
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION) VALUES('160','103','VALID_ACCESS_TIME','List of times when the system can be accessed');
INSERT INTO POLICY_DEF_PARAM (DEF_PARAM_ID, POLICY_DEF_ID, NAME, DESCRIPTION) VALUES('161','103','IP_BLACKLIST','List of IP Addresses to blacklist');
...
insert into POLICY (POLICY_ID, POLICY_DEF_ID, NAME, DESCRIPTION, STATUS, CREATE_DATE, CREATED_BY) VALUES ('4002','102', 'Audit Policy', 'Audit Policy', 1,curdate(), '3000');

/* Default Authn policy param */
insert into POLICY_ATTRIBUTE (POLICY_ATTR_ID, DEF_PARAM_ID, POLICY_ID, NAME, OPERATION,VALUE1)VALUES ('4100','150', '4001', 'DOMAIN_ID', '','USR_SEC_DOMAIN');
...
insert into POLICY_ATTRIBUTE (POLICY_ATTR_ID, DEF_PARAM_ID, POLICY_ID, NAME, OPERATION,VALUE1)VALUES ('4106','156', '4001', 'ACCESS_POLICY', '','');
...
INSERT INTO POLICY(POLICY_ID, POLICY_DEF_ID, NAME, DESCRIPTION, STATUS,RULE_SRC_URL) VALUES('4560', '104', 'principal', 'PRINCIPAL NAME', '1','provision/principal.groovy');
INSERT INTO POLICY(POLICY_ID, POLICY_DEF_ID, NAME, DESCRIPTION, STATUS,RULE_SRC_URL) VALUES('4561', '104', 'emailAddress', 'EMAIL ADDRESS', '1','provision/emailAddress.groovy');
...
insert into PROVISION_CONNECTOR(CONNECTOR_ID, NAME, METADATA_TYPE_ID, SERVICE_URL,SERVICE_NAMESPACE, SERVICE_PORT) VALUES ('50','AD CONNECTOR', 'AD_Connector','http://localhost:8080/idm-connector-ws/ActiveDirectoryConService','http://www.openiam.org/service/connector', 'ActiveDirectoryConServicePort' );
insert into PROVISION_CONNECTOR(CONNECTOR_ID, NAME, METADATA_TYPE_ID, SERVICE_URL,SERVICE_NAMESPACE, SERVICE_PORT) VALUES ('51','LDAP CONNECTOR', 'LDAP_Connector','http://localhost:8080/idm-connector-ws/LDAPConnectorService','http://www.openiam.org/service/connector', 'LDAPConnectorServicePort' );
insert into PROVISION_CONNECTOR(CONNECTOR_ID, NAME, METADATA_TYPE_ID, SERVICE_URL,SERVICE_NAMESPACE) VALUES ('52','ORACLE CONNECTOR', 'RDBMS_Connector','http://localhost:8080/idm-connector-ws/OracleConnectorService','http://www.openiam.org/service/connector' );

INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID) VALUES('0','OPENIAM', 'Primary IDENTITY', 'ACTIVE', null, 'USR_SEC_DOMAIN', null, null, null, '99'   );
INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID) VALUES('101','OPENIAM_LDAP', 'Primary Directory', 'ACTIVE', '51', 'USR_SEC_DOMAIN', 'ldap://96.56.80.245','389', 'SSL', '101'   );
INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID) VALUES('100','OPENIAM_AD', 'Domain Controller', 'ACTIVE', '50', 'USR_SEC_DOMAIN', 'ldap://96.56.80.245','389', 'SSL', '100'   );
INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID) VALUES('102','ORACLE_DB', 'DATABASE', 'ACTIVE', '52', 'USR_SEC_DOMAIN', '',null, 'CLEAR', '102'   );
...
insert into RES (RESOURCE_ID, RESOURCE_TYPE_ID,NAME, DISPLAY_ORDER) VALUES ('99', 'MANAGED_SYS', 'OPENIAM', 1);
insert into RES (RESOURCE_ID, RESOURCE_TYPE_ID,NAME, DISPLAY_ORDER, MANAGED_SYS_ID ) VALUES ('100', 'MANAGED_SYS', 'ACTIVE DIRECTORY', 1, '100');
insert into RES (RESOURCE_ID, RESOURCE_TYPE_ID,NAME, DISPLAY_ORDER, MANAGED_SYS_ID ) VALUES ('101', 'MANAGED_SYS', 'LDAP', 2, '101');
insert into RES (RESOURCE_ID, RESOURCE_TYPE_ID,NAME, DISPLAY_ORDER) VALUES ('102', 'MANAGED_SYS', 'ORACLE DB', 3);
...
insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('200', '101','INCLUDE_USER_OBJECT', 'N');
insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('201', '100','INCLUDE_USER_OBJECT', 'N');

insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('202', '101','PRINCIPAL_NAME', 'uid');
insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('203', '101','PRINCIPAL_PASSWORD', 'userPassword');

insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('204', '100','PRINCIPAL_NAME', 'userPrincipalName');
insert into RESOURCE_PROP(RESOURCE_PROP_ID, RESOURCE_ID, NAME, PROP_VALUE) VALUE ('205', '100','PRINCIPAL_PASSWORD', 'password');
...
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('100', 'START', null, 'SUPERVISOR', 1, '200', null);
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('101', 'ACCEPT', null, 'REQUESTEE', 1, '200', null);
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('102', 'REJECT', null, 'REQUESTOR', 1, '200', null);


INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('103', 'START', null, 'SUPERVISOR', 1, '201', null);
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('104', 'ACCEPT', null, 'REQUESTEE', 1, '201', null);
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('105', 'REJECT', null, 'REQUESTOR', 1, '201', null);

INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('106', 'START', null, 'SUPERVISOR', 1, '202', null);
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('107', 'ACCEPT', null, 'REQUESTEE', 1, '202', null);
INSERT INTO RES_APPROVER(RES_APPROVER_ID, TASK_ACTION, APPROVER_ID, APPROVER_TYPE, APPROVER_LEVEL, MANAGED_SYS_ID, MSG_ID)  VALUES('108', 'REJECT', null, 'REQUESTEE', 1, '202', null);


insert into MNG_SYS_OBJECT_MATCH(OBJECT_SEARCH_ID, MANAGED_SYS_ID, OBJECT_TYPE, MATCH_METHOD, SEARCH_FILTER, BASE_DN,KEY_FIELD) VALUES('100', '101', 'USER', 'BASE_DN', '(&(objectClass=person)(uid=?))','ou=people,dc=openiam,dc=org','uid');
insert into MNG_SYS_OBJECT_MATCH(OBJECT_SEARCH_ID, MANAGED_SYS_ID, OBJECT_TYPE, MATCH_METHOD, SEARCH_FILTER, BASE_DN,KEY_FIELD) VALUES('101', '100', 'USER', 'BASE_DN', '(&(objectClass=user)(sAMAccountName=?))','CN=Users,DC=build,DC=openiam,DC=local','cn');
...
INSERT INTO ATTRIBUTE_MAP(ATTRIBUTE_MAP_ID, MANAGED_SYS_ID, RESOURCE_ID, MAP_FOR_OBJECT_TYPE, ATTRIBUTE_NAME, ATTRIBUTE_POLICY_ID) VALUES ('209', '101', '101','PRINCIPAL', 'userPassword', '4509');
