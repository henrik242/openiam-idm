...
CREATE TABLE AUDIT_POLICY (
       AUDIT_POLICY_ID      varchar(32) NOT NULL,
       CATEGORY_ID          varchar(20) NULL,
...
CREATE TABLE TIME_POLICY (
       TIME_POLICY_ID       VARCHAR(32) NOT NULL,
       RESOURCE_POLICY_ID   varchar(32) NULL,
       CATEGORY_ID          varchar(20) NULL,
...
CREATE TABLE IP_POLICY (
       IP_POLICY_ID         varchar(32) NOT NULL,
       RESOURCE_POLICY_ID   varchar(32) NULL,
       CATEGORY_ID          varchar(20) NULL,
       ACTION               varchar(20) NULL,
...
CREATE TABLE POLICY_SCRIPT (
       POLICY_SCRIPT_ID     varchar(32) NOT NULL,
       RESOURCE_POLICY_ID   varchar(32) NULL,
       CATEGORY_ID          varchar(20) NULL,
...
CREATE TABLE RES_APPROVER(
    RES_APPROVER_ID     VARCHAR(32)    NOT NULL,
	TASK_ACTION    		VARCHAR(32)	   NULL,   /* START, ACCEPT, REJECT  */
    APPROVER_ID         VARCHAR(32)	   NULL,   /* ID of the approver  */
    APPROVER_TYPE		VARCHAR(20)    NULL,   /* SUPERVISOR, USER, GROUP */
    APPROVER_LEVEL      INTEGER	   NULL,   /* approval level */
    MANAGED_SYS_ID      VARCHAR(32)    NULL,
    MSG_ID      		VARCHAR(32)    NULL,  	/* EMAIL TEMPLATE TO USE FOR SENDING MAILS*/
PRIMARY KEY (RES_APPROVER_ID), 
	CONSTRAINT FK_RES_APPROV
			 	FOREIGN KEY (MANAGED_SYS_ID) REFERENCES MANAGED_SYS(MANAGED_SYS_ID)
) ENGINE=InnoDB;
