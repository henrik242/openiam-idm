...
public class UserMgrAddressTest extends AbstractDependencyInjectionSpringContextTests  {
	...
	public void testAddUserWithAddress() {
		Set<Address> adrMap = user.getAddresses();
		adrMap.add( adr4);
		
		adrId4 = adr4.getAddressId();
		
		user2.setAddresses(adrMap);
		
		
		userMgr.addUserWithDependent(user2,true);
