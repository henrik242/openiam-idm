...
public class UserRoleDataServiceTest extends
AbstractOpenIAMTestCase {
	...
	public void testAddUser2ToRole() {
		...
		Role r = roleMgr.getRole("IDM", "NewRole1");
		r.getUsers().add(u);
	...
	public void testAddUserToRole3() {
		...
		System.out.println("Role Id= " + role3.getId().getRoleId()) ;
		System.out.println("User in role = " + roleMgr.getRole(role3.getId().getServiceId(), role3.getId().getRoleId()).getUsers());
	}
	...
	public void testAddUserToGroup() {
		...
		roleMgr.addGroupToRole("IDM", "NewRole1", grp.getGrpId());


	}
	public void testGetUsersInRole() {
		User[] userAry = roleMgr.getUsersInRole("IDM", "NewRole1");
	...
	public void testGetRole() {
		Role role = roleMgr.getRole("IDM", "NewRole1");
		assertNotNull(role);
