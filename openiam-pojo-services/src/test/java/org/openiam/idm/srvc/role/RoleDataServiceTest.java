...
public class RoleDataServiceTest extends AbstractOpenIAMTestCase  {
	...
	public void testAddRoleAttribute1() {
		...
		Role r = roleMgr.getRole(role.getId().getServiceId(), role.getId().getRoleId());
		roleAttr1.setRoleId(role.getId().getRoleId());
		roleAttr1.setServiceId(role.getId().getServiceId());
		r.getRoleAttributes().add(roleAttr1);
	...
	public void testAddRoleAttributeWithoutRole() {
