...
public class DerbyUtil {
	...
	static protected ResourceBundle datasource = ResourceBundle.getBundle("datasource");
	...
	public static void buildOpeniamDB() throws Exception
	{
		...
		//ij.runScript(conn, new FileInputStream(datasource.getString("schema_root") + "/all/derby_schema_all.sql"), "US-ASCII", os, "US-ASCII");	
