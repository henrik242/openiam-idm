...
/*		if (principal == null || principal.length()==0) {
		...
		if (password == null 	|| password.equals("")) {
			log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "INVALID PASSWORD", domainId, null, principal, null, null);
...
*/		
		...
		if (!decryptPswd.equals(password)) {
			...
			if (attrValue != null) {
				...
				if (failCount >= authFailCount) {
					...
					log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "ACCOUNT LOCKED", domainId, null, principal, null, null);
			...
			if (pswdResult == AuthenticationConstants.RESULT_PASSWORD_EXPIRED) {
				log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "PASSWORD EXPIRED", domainId, null, principal, null, null);
