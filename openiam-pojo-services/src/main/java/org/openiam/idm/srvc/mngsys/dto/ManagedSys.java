...
public class ManagedSys implements java.io.Serializable {
	...
	private Set<SysAttributeMap> sysAttributeMaps = new HashSet<SysAttributeMap>(
			0);
	...
	public ManagedSys(String managedSysId, String name, String description,
			...
			Set<SysAttributeMap> sysAttributeMaps, Set<SysApprover> sysApprovers) {
		this.managedSysId = managedSysId;
		this.name = name;
	...
	public Set<SysAttributeMap> getSysAttributeMaps() {
		return this.sysAttributeMaps;
	}

	public void setSysAttributeMaps(Set<SysAttributeMap> sysAttributeMaps) {
		this.sysAttributeMaps = sysAttributeMaps;
	}
