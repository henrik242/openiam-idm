...
public class RoleDataServiceImpl implements RoleDataService {
	...
	public Role getRole(String serviceId, String roleId) {
		...
		return roleDao.findById(new RoleId(serviceId, roleId));

	}
	
	public Role getRoleWithDependants(String serviceId, String roleId) {
		if (roleId == null)
			throw new NullPointerException("roleId is null");
		if (serviceId == null)
	...
	public Role[] getAllRoles() {
		...
		List roleList = roleDao.findAllRoles();
	...
	public User[] getUsersInRole(String serviceId, String roleId) {
		...
		Role rl = getRoleWithDependants(serviceId, roleId);
