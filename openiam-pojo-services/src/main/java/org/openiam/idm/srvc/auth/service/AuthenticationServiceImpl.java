...
public class AuthenticationServiceImpl implements AuthenticationService {
	 ...
	 */
	public Subject passwordAuth(String secDomainId, String principal, String password) throws AuthenticationException {
		...
		if ( modSel.getModuleType() == LoginModuleSelector.MODULE_TYPE_LOGIN_MODULE) {
			try {
				...
				throw new AuthenticationException(ae.getErrorCode());
			}
		}else {
