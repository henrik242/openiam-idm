...
@WebService(endpointInterface = "org.openiam.idm.srvc.res.service.ResourceDataService", 
		targetNamespace = "urn:idm.openiam.org/srvc/res/service", 
		portName = "ResourceDataWebServicePort",
		serviceName = "ResourceDataWebService")
public class ResourceDataServiceImpl implements ResourceDataService   {
	 ...
	 * @return
	 */
//	public Resource addChildResource(Resource resource, Resource resourceParent) {
...
//	}
	 ...
	 * @return
	 */
//	public Resource addTypedResource(Resource resource, String resourceTypeId) {
...
//	 * @return
//	 */
//	public ResourceProp addLinkedResourceProp(ResourceProp resourceProp, String resourceId) {		
//		if (resourceId == null)
//			throw new IllegalArgumentException("resourceId is null");
...
//
	...
	public String getResourceTreeXML(String resourceId) {
		...
		xml.append("<Resource label='" + getResourceType(mainResource) + mainResource.getName() + "' resourceId='" +
				mainResource.getResourceId() + "'>");
		//xml.append("<ResourceId label='id'>" + mainResource.getResourceId()	+ "</ResourceId>");
		//xml.append("<ResourceDescription label='desc'>" + mainResource.getDescription()+ "</ResourceDescription>");
		...
		for (Iterator<Resource> it = resourceTree.iterator(); it.hasNext();) {
			...
			xml.append("<Resource label='" + getResourceType(r) + r.getName() + "' resourceId='" + r.getResourceId() +
					"'>");
			//xml.append("<ResourceId label='id'>" + r.getResourceId() + "</ResourceId>");
			//xml.append("<ResourceDescription label='desc'>" + r.getDescription()+ "</ResourceDescription>");
...
//
// List<Resource> rootChildren = resourceDao.getResourcesByParent(resourceId);
//
...
// ++nodeLevel;
//
// List<Resource> childResources = resourceDao.getResourcesByParent(resourceId);
...
public List<ResourceRole> getAllResourceRoles() {
	List<ResourceRole> resourceRoleList = resourceRoleDao.findAllResourceRoles();
...
/* (non-Javadoc)
 * @see org.openiam.idm.srvc.res.service.ResourceDataService#addUserToResource(org.openiam.idm.srvc.res.dto.ResourceUser)
 */
...
/* (non-Javadoc)
 * @see org.openiam.idm.srvc.res.service.ResourceDataService#getUserResources(java.lang.String)
 */
...
/* (non-Javadoc)
 * @see org.openiam.idm.srvc.res.service.ResourceDataService#removeUserFromAllResources(java.lang.String)
 */
...
/* (non-Javadoc)
 * @see org.openiam.idm.srvc.res.service.ResourceDataService#getResourcesForRole(java.lang.String, java.lang.String)
 */
public List<ResourceRole> getResourcesForRole(String domainId, String roleId) {
	return resourceRoleDao.findResourcesForRole(domainId, roleId);
}
 ...
 * @return
 */
 public List<Resource> getResourceListForRole(String domainId, String roleId) {
		if (domainId == null) {
		...
		return resourceDao.findResourceForRole(domainId, roleId);
 }
	...
	public boolean isRoleAuthorized(String domainId, String roleId, String resourceId) {
		log.info("isUserAuthorized called.");
		
		List<Resource> resList = this.getResourceListForRole(domainId, roleId);
		 log.info("- resList= " + resList);
		 if ( resList == null) {
			 log.info("resource list for user is null");
			 return false;
	 ...
	 * @return
	 */
	public List<Resource> getResourceForRoleList(String domainId, List<String> roleIdList) {
		if (domainId == null) {
			 throw new IllegalArgumentException("domainId is null");
		}
		if (roleIdList == null) {
		...
		return resourceDao.findResourceForRoleList(domainId, roleIdList);		
	}

	public List<AttributeMap> getAttributeMapForResource(String resourceId) {
		if (resourceId == null) {
			 throw new IllegalArgumentException("resourceId is null");
		}		
...
// * @return
// */
// public List<ResourceRole> findResourceRoles(String resourceId) {
// if (resourceId == null)
// throw new IllegalArgumentException("resourceId is null");
// return this.resourceDao.findResourceRoles(resourceId);
// }
//
//
// /**
...
//	
// this.resourceDao.addResourceRolePrivilege(resourceId, roleId, privilegeId);
// }
//
// /**
...
// * @param resourceId the resource id
// */
// void removeAllRolePrivilegesFromResource(String resourceId) {
// if (resourceId == null)
// throw new IllegalArgumentException("resourceId is null");
//	
// this.resourceDao.removeAllRolePrivilegesFromResource(resourceId);
// }
//
