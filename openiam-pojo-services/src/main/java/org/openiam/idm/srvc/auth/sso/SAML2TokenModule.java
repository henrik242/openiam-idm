...
private Subject buildSubject(String userId, String principal, String issuer) {
	...
	public static void main(String [] args) {
		...
		tokenParam.put("PRINCIPAL", "snelson");
		tokenParam.put("USER_ID", "3006");
		...
		// remove the prolog from the assertion
	//	int index = saml.indexOf(">");
	//	String str = saml.substring(index+1);
		
	//	System.out.println("str=" + str);
		
		boolean retval =  token.isTokenValid("3006", saml);
		
		System.out.println("Token valid=" + retval);
