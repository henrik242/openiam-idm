...
// method serves no useful purpose - why leave props without a resourceId	
...
// user resource update to set parentId	
...
// ResourceRole--------------------------------------------------------------------
	...
	public List<ResourceRole> findResourceRoles(String resourceId) {
		...
		qry.setString("resourceId", resourceId);
		qry.setCacheable(true);
		qry.setCacheRegion("query.resource.findResourceRole");
	...
	public int removeAllRolePrivilegesFromResource(String resourceId) {
		Session session = sessionFactory.getCurrentSession();
