/**
 * ------------------------------------------------------------------------------ 
 * Title: NavigationDispatchAction
 * Author: APS
 * Overview: base class for struts DispatchAction classes
 * ------------------------------------------------------------------------------
...
//public class NavigationDispatchAction extends DispatchAction {
	
public class NavigationDispatchAction extends DispatchActionSupport {
		

/**
  * This ia a base class which can either be used as it is, or is a super
  ...
  */
  ...
  NavigationAccess navAccess = new NavigationAccess();

  public ActionForward setNavigation(ActionMapping mapping,
                  ActionForm form,
