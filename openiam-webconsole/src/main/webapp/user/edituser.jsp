			...
			<legend>EDIT USER INFORMATION</legend>
				...
				<table class="fieldsetTable"  width="100%" >
				   ...
				   <tr>
				       ...
				       <td><label for="username" class="attribute"></label><font color="red">*</font></td>
				       <td class="userformInput" for="username" class="labelValue"></td>						
				    </tr>				   
				   ...
				   <tr>
				    ...
				    <tr>
				     ...
				     <tr >
						...
						<td class="userformInput" for="username" class="labelValue"><form:input path="user.status" size="20" readonly="true"/>
						...
						<td colspan="3" class="userformInput" for="username" class="labelValue"><form:input path="user.secondaryStatus" size="20" readonly="true" />
		...
		<tr>
				<td class="buttonRow" align="right">
				 ...
				 <input type="submit" name="saveBtn" value="DELETE"/> | 
				   ...
				   <input type="submit" name="saveBtn" value="LOCK"/> <input type="submit" name="saveBtn" value="UN-LOCK"/>
					   
				 
				    	  | <input type="submit" name="saveBtn" value="Save"/>   <input type="submit" name="saveBtn" value="Cancel"/>   
