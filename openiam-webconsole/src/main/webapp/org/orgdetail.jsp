...
<table width="100%">
	<tr>
      <td colspan="2" class="title">         
          ...
          <tr>
              <td class="tddark" >Alias</td>
			  <td class="tdlightnormal"><form:input path="org.alias" size="40" maxlength="40" />
			  </td>
		  </tr> 
          <tr>
              <td class="tddark" >Internal Organization ID</td>
			  <td class="tdlightnormal"><form:input path="org.internalOrgId" size="40" maxlength="40" />
			  </td>
		  </tr> 		  
          <tr>
          ...
          <tr>
              <td class="tddark" colspan="2" align="center">Custom Attributes for Organization</td>
		  </tr>  
