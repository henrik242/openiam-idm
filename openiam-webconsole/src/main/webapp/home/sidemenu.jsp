...
<% if ( sideMenuGroup!= null && sideMenuGroup.equalsIgnoreCase("SECURITY_ROLE")) { 
	 String typeId = (String)request.getAttribute("typeId");
%>
<div id="menu12">
 <ul>
    <!-- CSS Tabs -->
    <li><a href="roleDetail.cnt?domainid=<%=domainId%>&roleid=<%=roleId%>&menuGroup=SECURITY_ROLE">Role Detail</a></li>
	<li><a href="roleResource.cnt?domainid=<%=domainId%>&roleid=<%=roleId%>&menuGroup=SECURITY_ROLE"">Resources</a></li>
