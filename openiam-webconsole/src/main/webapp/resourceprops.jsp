<%@ page import="java.util.*,javax.servlet.http.*,diamelle.base.prop.*,org.openiam.webadmin.busdel.base.*"%>
...
<%@ taglib uri="http://struts.apache.org/tags-tiles" prefix="tiles" %>
 ...
 %>
  ...
  <table cellspacing=2 cellpadding=2 width="100%" align="center">
		...
		<html:form action = "/security/resource.do?method=handleProperties" >
    ...
    <input type="hidden"  name="propId" value="<%=p.getId()%>" />
		...
		<tr bgcolor="#eeeeee">
         ...
         <a href="security/resource.do?method=editProperty&resourcePropId=<%=p.getId()%>&resourceId=<%=resourceId%>">
         <%= p.getId() %></a>
      </td>
