...
<table width="100%">
  ...
  <form:hidden path="domain.domainId"  />
          ...
          <tr>
			  <td class="tddark">Password Policy</td>
              <td class="tdlightnormal" >
              <form:select path="domain.passwordPolicyId" multiple="false">
              	<form:option value="" label="-Please Select-"/>
              	<form:options items="${passwordPolicyList}" itemValue="policyId" itemLabel="name"/>
         	  </form:select> 
              
              </td>
          </tr>
          <tr>
			  <td class="tddark">Audit Policy</td>
              <td class="tdlightnormal" >
              <form:select path="domain.auditPolicyId" multiple="false">
              	<form:option value="" label="-Please Select-"/>
              	<form:options items="${auditPolicyList}" itemValue="policyId" itemLabel="name"/>
         	  </form:select> 
              </td>
          </tr>
            <tr>
              ...
              <td class="tdlightnormal" >
               <form:select path="domain.authnPolicyId" multiple="false">
              	...
              	<form:options items="${authnPolicyList}" itemValue="policyId" itemLabel="name"/>
                   ...
                   <tr>
			  <td class="tddark">Default Managed System</td>
              <td class="tdlightnormal" ><form:input path="domain.authSysId" size="20" maxlength="20" /></td>
          </tr>
          
          <tr>
			  <td class="tddark">Default Login Module</td>
              <td class="tdlightnormal" ><form:input path="domain.defaultLoginModule" size="40" maxlength="100" /></td>
          </tr>
