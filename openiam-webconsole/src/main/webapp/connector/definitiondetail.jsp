   ...
   <tr>
 		<td colspan="2" align="center" bgcolor="8397B4" >
          ...
          <tr>
              ...
              <td class="tdlightnormal" ><form:input path="serviceUrl" size="60" maxlength="100" /></td>
          </tr>
          <tr>
			  <td class="tddark">Service Namespace</td>
              <td class="tdlightnormal" ><form:input path="serviceNameSpace" size="60" maxlength="100" /></td>
          </tr>
          <tr>
			  <td class="tddark">Service Port</td>
              <td class="tdlightnormal" ><form:input path="servicePort" size="60" maxlength="60" /></td>
          </tr>
