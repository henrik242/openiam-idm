...
<form:form commandName="connectorDetailCmd">
        ...
        <td><form:input path="metadataTypeId" size="40" maxlength="40" /></td>
		  ...
		  <td >Connector Interface Type</td>
        	<td>
        			<form:select path="connectorInterface">
		              <form:option value="LOCAL" />
          ...
          <tr>
			  <td >Service URL</td>
        <td><form:input path="serviceUrl" size="80" maxlength="100" /></td>
          </tr>
          <tr>
			  <td>Service Namespace</td>
        <td><form:input path="serviceNameSpace" size="80" maxlength="100" /></td>
          </tr>
          <tr>
			  	<td>Service Port</td>
