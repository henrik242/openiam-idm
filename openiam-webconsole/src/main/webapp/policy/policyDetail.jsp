 		...
 		<td colspan="3" align="center" bgcolor="8397B4" >
          ...
          <tr>
			  ...
			  <td class="tdlightnormal" colspan="2"><form:errors path="policy.name" cssClass="error"  />
			  		<form:input path="policy.name" size="60" maxlength="60" readonly="true"  />
			  </td>
		  </tr>
          <tr>
          ...
          <tr>
              <td class="tddark" width="20%">Policy Type<font color="red">*</font></td>
			  <td class="tdlightnormal" colspan="2">
			  		<form:select path="policy.policyDefId">
			  		<form:option value="-1" >-Select a value</form:option>
	             	<form:option value="100">Password</form:option>
	             	<form:option value="103">Authentication</form:option> 
          		</form:select>
			  </td>
		  </tr>
          <tr>
