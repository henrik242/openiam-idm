...
<table width="100%">
   ...
   <tr>
 		<td colspan="2" align="center" bgcolor="8397B4" >
          ...
          <tr>
			  <td class="tddark">Type Id<font color="red">*</font></td>
              <td class="tdlightnormal"><form:input path="metadataType.metadataTypeId" size="32" maxlength="20"  /></td>
          </tr>
          <tr>
              <td class="tddark">Type Name<font color="red">*</font></td>
			  <td class="tdlightnormal"><form:input path="metadataType.description" size="40" maxlength="40"  /></td>
		  </tr>
