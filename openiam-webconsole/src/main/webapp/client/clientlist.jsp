...
<form:form commandName="clientListCmd">
    ...
    <td><form:input path="nameFilter" size="40"/> </td>
     ...
     <tr>
        ...
        <form:select path="orgType">
          ...
          <tr class="button">
          	  <td colspan="2"><a href="custDetail.cnt">New Client</a></td>
...
<table width="600pt" >
			<tr>
				<td align="center" height="100%">
			     <fieldset class="userform" >
						<legend>CLIENT LIST - ${resultsize} Organization(s) found.</legend>
	...
	<c:forEach items="${searchResult}" var="org">
		<tr>
			...
			<td class="tableEntry"><a href="custDetail.cnt?orgId=${org.orgId}">${org.organizationName}</a></td>
