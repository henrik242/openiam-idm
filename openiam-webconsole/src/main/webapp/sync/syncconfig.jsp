...
<form:form commandName="syncCmd">
          ...
          <tr>
			  ...
			  <td class="tdlightnormal"><form:hidden path="syncConfig.synchConfigId"  />
          ...
          <tr>
			  ...
			  <td class="tdlightnormal"><form:input path="syncConfig.srcPassword" size="60" maxlength="60"  /> </td>
		  </tr> 
          ...
          <tr>
              <td class="tddark">Validate Rule</td>
			  <td class="normaltext"><form:input path="syncConfig.validationRule" size="60" maxlength="60"  />
			   <br><i>Validates the row of data for accepting it into the transformation process</i> </td>
		  </tr>
          <tr>
			  ...
			  <br><i>Transforms the data into a form that can be used by the identity manager.</i>  </td>
		  </tr> 		  		  		  		  
          <tr>
