...
<form:form commandName="syncCmd">
          ...
          <tr>
			  ...
			  <td class="tdlightnormal">
              <form:select path="syncConfig.processRule" multiple="false">
              <form:option value="USER" label="USER"/>
              <form:option value="ROLE" label="ROLE"/>
              <form:option value="ORG" label="ORGANIZATION"/>
          </form:select>
                  <br><i>ROLE and ORGANIZATION are only supported while CSV. Users may by synchronized
              with all source adapters</i>
              </td>
		  </tr>
          ...
          <tr>
			  ...
			  <td class="tdlightnormal"><form:password path="syncConfig.srcPassword" size="60" maxlength="60" showPassword="true"  /> </td>
		  </tr> 
