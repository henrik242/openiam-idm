...
public class ReconConfigurationController extends SimpleFormController {
	...
	protected Object formBackingObject(HttpServletRequest request) 			throws Exception {
		...
		cmd.getSituationList().add(new ReconciliationSituation(null,"Confirmed"));
		cmd.getSituationList().add(new ReconciliationSituation(null,"Delete"));
		cmd.getSituationList().add(new ReconciliationSituation(null,"Found"));
		cmd.getSituationList().add(new ReconciliationSituation(null,"Missing"));
