 ...
 *
 */
public class AuditReportValidator implements Validator {

	

	public boolean supports(Class cls) {
		 return AuditReportCommand.class.equals(cls);
	}

	public void validate(Object cmd, Errors err) {
		// TODO Auto-generated method stub
		AuditReportCommand auditCommand =  (AuditReportCommand) cmd;
