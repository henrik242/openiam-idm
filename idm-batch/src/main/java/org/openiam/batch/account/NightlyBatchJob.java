 ...
 *
 */
public class NightlyBatchJob implements ApplicationContextAware {
	
	
	private static final Log log = LogFactory.getLog(NightlyBatchJob.class);
	...
	public void execute() {
		log.info("NightlyBatchJob called.");
